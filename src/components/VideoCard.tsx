      ...
      <div className={`relative aspect-video overflow-hidden rounded-lg shadow-md shadow-transparent ring-1 ring-transparent transition-all duration-300 group-hover:shadow-lg group-hover:shadow-sonar-red/25 group-hover:ring-sonar-red/30 ${fluid ? "w-full" : "w-[280px] sm:w-[320px]"}`}>
        ...
        {onRemove && (
          <button
            ...
            className="absolute -top-1 -right-1 z-10 flex h-11 w-11 items-center justify-center rounded-full text-n5 max-sm:opacity-100 sm:opacity-0 transition-all duration-200 hover:text-white group-hover:opacity-100 group-focus-within:opacity-100 focus-visible:opacity-100"
