  ...
  return (
    <div>
      ...
      <button
        ...
        className={`fixed bottom-safe right-20 z-40 flex h-11 items-center gap-2 rounded-full border border-qube-blue bg-qube-blue px-4 text-white shadow-lg shadow-qube-blue/30 backdrop-blur-md transition-all duration-300 hover:bg-qube-blue/85 hover:shadow-xl hover:shadow-qube-blue/40 focus-visible:ring-2 focus-visible:ring-qube-blue focus-visible:outline-none ${
