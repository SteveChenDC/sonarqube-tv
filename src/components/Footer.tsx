export default function Footer() {
  return (
    <footer className="relative border-t border-n8/50 bg-n9 px-4 pt-12 pb-16 sm:px-6">
      <div className="absolute inset-x-0 top-0 h-0.5 bg-gradient-to-r from-transparent via-sonar-red to-transparent" />
      <div className="absolute inset-x-0 -top-16 h-16 bg-gradient-to-b from-transparent to-n9 pointer-events-none" />
