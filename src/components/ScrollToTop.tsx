...
export default function ScrollToTop({ hidden = false }: Readonly<{ hidden?: boolean }>) {
  ...
  return (
    <button
      ...
      className={`fixed bottom-safe right-6 z-40 flex h-11 w-11 items-center justify-center rounded-full border border-n8 bg-n9/90 text-n5 shadow-lg backdrop-blur-sm transition-all duration-300 hover:border-n7 hover:bg-n8 hover:text-n1 focus-visible:ring-2 focus-visible:ring-qube-blue focus-visible:outline-none ${
        visible && !hidden
